...
const cars = ["Bmw", "Mazda", "Mercedes", "Skoda", "Nissan", "Bentley", "Audi", "Ferrari"]
console.log(cars[4]);

// - 2

const cars2 = ["Bmw", "Mazda", "Mercedes", "Skoda", "Nissan", "Bentley", "Audi", "Ferrari"]
console.log(cars2.length, cars2[7]);

// - 3

const personal = ["Samuel", "Radko", 24]
personal[0] = "Jonny"
...
const player = ["Juggernut", "Preist", "Paladin"]
player.push("Druid")
console.log(player)
